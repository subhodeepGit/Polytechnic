...
#   bench execute polytechnic.patches.migrate_patch.get_custom_role_permission
...
#   bench execute polytechnic.patches.migrate_patch.set_custom_role_permission
def set_custom_role_permission():
    with open(frappe.get_app_path("polytechnic","fixtures","custom_docperm.json")) as f:
...
# #   bench execute polytechnic.patches.migrate_patch.add_roles
# def add_roles():
#     with open(frappe.get_app_path("polytechnic","fixtures","role.json")) as f:
#         for d in json.load(f):
...
#     with open(frappe.get_app_path("polytechnic","fixtures","module_profile.json")) as f:
#         for d in json.load(f):
