...
#                                 where enabled=1 and (st.name LIKE %(txt)s or st.title LIKE %(txt)s) 
#                                 or 
#                                 st.kiit_polytechnic_roll_no LIKE %(txt)s 
#                                 or 
#                                 st.vidyarthi_portal_id LIKE %(txt)s 
#                                 or
#                                 st.sams_portal_id LIKE %(txt)s ) and ced.programs='{0}'""".format(filters.get("programs")),dict(txt="%{}%".format(txt)))
