...
def get_data(filters):
	...
	for t in Gl_entry:
		...
		if len(Gl_entry_info):
			...
			Payment_Entry_info=frappe.get_all("Payment Entry",filters=[["name","=",Gl_entry_info['voucher_no']],["mode_of_payment","!=","Fees Refundable / Adjustable"],["payment_type","=","Receive"],["docstatus",'=',1]])
